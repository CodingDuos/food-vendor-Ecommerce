...
class MobileHeaderInformationContainer extends StatefulWidget {
  const MobileHeaderInformationContainer({super.key});

  @override
  State<MobileHeaderInformationContainer> createState() =>
      _HeaderInformationContainerState();
}

class _HeaderInformationContainerState
    extends State<MobileHeaderInformationContainer> {
                                      ...
                                      child: Container(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            mainController.cartListItems.first
                                                    .product!
                                                    .where((element) =>
                                                        element.uuid ==
                                                        data.uuid)
