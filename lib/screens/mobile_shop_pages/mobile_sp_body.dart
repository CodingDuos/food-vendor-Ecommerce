...
import 'package:food_ecommerce/screens/mobile_shop_pages/mobile_sp_product_header.dart';

import 'package:provider/provider.dart';

class MobileShopPageBody extends StatelessWidget {
  const MobileShopPageBody({super.key});
    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          const MobileShopPageBodyViewWidget()
        ],
      ),
    );
  }
...
class MobileShopPageBodyViewWidget extends StatefulWidget {
  const MobileShopPageBodyViewWidget({super.key});

  @override
  State<MobileShopPageBodyViewWidget> createState() =>
      _MobileShopPageBodyViewWidgetState();
}

class _MobileShopPageBodyViewWidgetState
    extends State<MobileShopPageBodyViewWidget> {
  @override
  Widget build(BuildContext context) {
      ...
      child: Row(
        ...
        children: [
          Expanded(
              ...
              child: Column(
                children: [
                  const MobileHeaderInformationContainer(),
                  const SizedBox(
                    height: 10,
                  ),
                  Container(
                                ...
                                return ListView(
                                    ...
                                    children:
                                      ...
                                      return Padding(
                                        ...
                                        child: InkWell(
                                          onTap: () {
                                            mainController.setSelectedCategory(
                                                e.name, e.uuid);
                                            mainController
                                                .setSelectedSubCategory('', '');
                                          },
                                  ...
                                  builder: (context, snapshot) {
                                    if (snapshot.connectionState ==
                                      ...
                                      if (snapshot.hasError) {
                                        ...
                                        List<DisplayLevelCategoriesModel>
                                            subCategoriesData = snapshot.data!;
                          ...
                          return ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return CustomFutureBuilder(
                                  displayLevelUUId:
                                      mainController.currentDisplayLevel!.uuid,
