...
import 'package:food_ecommerce/screens/shop_page/pages/view_order_basket.dart';
...
class _YourOrderState extends State<YourOrder> {
                      ...
                      showDialog(
                        ...
                        builder: (context) {
                          return AlertDialog(
                            ...
                            title: const Text('Do you have a food allergy?'),
                            content: const SizedBox(
                              width: 400,
                              child: Text(
                                'If you have a food allergy or intolerance (or someone you\'re ordering for has), '
                                'phone the restaurant on 01418103095 before placing your order and read '
                                'what this restaurant has to say about allergies. Do not order if you cannot '
              ...
              children: [
                Expanded(
                  child: GridView.count(
                    crossAxisCount: mainController.servicesList.length,
                    ...
                    children: mainController.servicesList.map((e) {
                      ...
                      return InkWell(
                        onTap: () {
                          ...
                          mainController
                              .setselectedServiceType(e.name.toString());
                        },
                        child: AnimatedContainer(
                          ...
                          child: Row(
                            children: [
                              Expanded(
                                child: Container(
                                  child: buildToggleButtonContent(
                                      e.name.toString(), isSelected),
                                ),
                              ),
                              Container(width: 2),
                              mainController.servicesList.first.name == e.name
              ...
              Expanded(
                child: Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 5),
                    buildQuantityButton(Icons.add, () {
                      addModifiersQunatity(productData, modifiers);
                    }),
                    const SizedBox(width: 5),
                  ],
                ),
      ...
      child: Container(
          ...
          child: const TextField(
            decoration: InputDecoration(
                ...
                hintText: 'Additional Restaurant Notes',
  ...
  subtractModifiersQunatity(var productData, var modifiers) {
    ...
    final productMatches =
        cartItems.product?.where((element) => element == productData);
