...
void showAnimatedDialogModifers(
...
class ModifersDialog extends StatefulWidget {
  const ModifersDialog(
...
class _ModifersDialogState extends State<ModifersDialog>
                                                                        ...
                                                                        ? Row(
                                                                            children: [
                                                                              ManageQuantityCommonWidget(
                                                                                onremove: () {
                                                                                  submodifers.quantity = submodifers.quantity! - 1;
                                                                                  if (submodifers.quantity! == 0) {
                                                                                    submodifers.isselected = false;
                                                                                    submodifers.quantity = 1;
                                                                                    desktopselectedItemsList.removeWhere((item) => item.parentGroupName == modifiers.group_name.toString() && item.selectedItem == submodifers);
                                                                                  }
                                                                                  setState(() {});
                                                                                },
                                                                                onadd: () {
                                                                                  submodifers.quantity = submodifers.quantity! + 1;
                                                                                  if (submodifers.isselected == false) {
                                                                                    desktopselectedItemsList.add(
                                                                                      SelectedItem(modifiers.group_name.toString(), submodifers, modifiers.modifier_group_uuid.toString()),
                                                                                    );
                                                                                    submodifers.isselected = true;
                                                                                  }
                                                                                  setState(() {});
                                                                                },
                                                                                qunatity: submodifers.quantity.toString(),
                                                                              ),
                                                                              const SizedBox(width: 20),
                                                                            ],
                                                                          )
